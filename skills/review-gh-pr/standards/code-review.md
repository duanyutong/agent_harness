...
For principles and best practices, see [principles.md](./principles.md).
...
- [ ] Code follows all principles in [principles.md](./principles.md) and applicable adjacent language-specific guidelines
